(function() {
  ...
  module.exports = AccountMethods = (function() {
    ...
    function AccountMethods(models) {
      ...
      this.countAllForOwner = __bind(this.countAllForOwner, this);
    ...
    AccountMethods.prototype.countAllForOwner = function(userId, options, cb) {
      if (options == null) {
        options = {};
      }
      if (cb == null) {
      ...
      return this.models.Account.count(options.where, (function(_this) {
        return function(err, totalCount) {
          if (err) {
            return cb(err);
          }
